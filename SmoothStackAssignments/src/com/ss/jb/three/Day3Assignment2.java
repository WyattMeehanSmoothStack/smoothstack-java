...
/**
 * This class is for solving Assignment 2 Java Basics part 3.
 * It appends text to an existing text file. 
 * @author Wyatt Meehan
 */
public class Day3Assignment2 {
	...
	/**
	 * This main method creates a loop allowing the user to append to a file multiple times.
	...
	/**
	 * This method prompts the user for a file path and makes
	 * sure it exists and is a text file.
	...
	/**
	 * This method prompts the user for the text they would like to append
	 * and gives them the option to exit the program. 
